    ...
    return function get(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const toRemove = Object.assign(Object.assign({}, info), { source, id: httpRequest.params.id // when id is passed
                 });
                const view = yield deleteBooks(toRemove);
                return {
                    headers: {
                        'Content-Type': 'application/json'
                    },
