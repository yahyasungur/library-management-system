    ...
    return function post(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const posted = yield addRecords(Object.assign(Object.assign({}, info), { source, userId: httpRequest.params.userId, bookId: httpRequest.params.bookId, operation: 'return' }));
                return {
                    headers: {
